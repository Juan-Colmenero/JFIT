...
public class PostWorkoutAdapter extends RecyclerView.Adapter<PostWorkoutAdapter.WorkoutViewHolder> {

    Context context;
    ArrayList<UserWorkoutCategory> arrayList;
    private int USER_ID;
    private String body_part, mDate;

    public PostWorkoutAdapter(Context context, ArrayList<UserWorkoutCategory> arrayList)
    {
    ...
    public void onBindViewHolder(@NonNull final WorkoutViewHolder holder, final int position) {
        ...
        PostWorkoutSubcategoryAdapter postWorkoutSubcategory = new PostWorkoutSubcategoryAdapter(context, singleItem, userWorkoutCategory.getBodyPart(),userWorkoutCategory.getDate(), KEY_ID);
    ...
    private void deleteBodyWorkout(){
